...
We've tested this PyTables version with HDF5 1.6.5 and numarray 1.5.0,
...
recent version of them (>= 0.9.6 for NumPy and >= 24.x for
Numeric). PyTables has been successfully tested against NumPy 0.9.6
and Numeric 24.2.
