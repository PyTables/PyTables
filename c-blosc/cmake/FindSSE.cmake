...
IF(CMAKE_SYSTEM_NAME MATCHES "Linux")
   ...
   ELSE (SSE2_TRUE)
      set(SSE2_FOUND false CACHE BOOL "SSE2 not available on host")
   ENDIF (SSE2_TRUE)
   ...
   ELSE (SSE3_TRUE OR SSSE3_TRUE)
      set(SSE3_FOUND false CACHE BOOL "SSE3 not available on host")
   ENDIF (SSE3_TRUE OR SSSE3_TRUE)
   IF (SSSE3_TRUE)
      set(SSSE3_FOUND true CACHE BOOL "SSSE3 available on host")
   ELSE (SSSE3_TRUE)
      set(SSSE3_FOUND false CACHE BOOL "SSSE3 not available on host")
   ENDIF (SSSE3_TRUE)
   ...
   ELSE (SSE41_TRUE)
      set(SSE4_1_FOUND false CACHE BOOL "SSE4.1 not available on host")
   ENDIF (SSE41_TRUE)
   ...
   ELSE (AVX_TRUE)
      set(AVX_FOUND false CACHE BOOL "AVX not available on host")
   ENDIF (AVX_TRUE)
...
ELSEIF(CMAKE_SYSTEM_NAME MATCHES "Darwin")
   ...
   STRING(REGEX REPLACE "^.*(AVX2).*$" "\\1" SSE_THERE ${CPUINFO})
   STRING(COMPARE EQUAL "AVX" "${SSE_THERE}" AVX2_TRUE)
   IF (AVX2_TRUE)
      set(AVX2_FOUND true CACHE BOOL "AVX2 available on host")
   ELSE (AVX2_TRUE)
      set(AVX2_FOUND false CACHE BOOL "AVX2 not available on host")
...
ELSEIF(CMAKE_SYSTEM_NAME MATCHES "Windows")
   ...
   set(SSE4_1_FOUND false CACHE BOOL "SSE4.1 not available on host")
   set(AVX_FOUND false CACHE BOOL "AVX not available on host")
   set(AVX2_FOUND false CACHE BOOL "AVX not available on host")
