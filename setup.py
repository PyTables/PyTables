...
""",
      ...
      author = 'Carabos Coop. V.',
      author_email = 'info@carabos.com',
      maintainer = 'Carabos Coop. V.',
      maintainer_email = 'info@carabos.com',
      url = 'http://www.carabos.com/products/pytables-pro',
