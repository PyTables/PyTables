...
class BasicTestCase(common.PyTablesTestCase):
    ...
    def test02b_AppendRows(self):
        ...
        # Get their row object
        row = table.row
        # Append some rows (3*table._v_maxTuples is enough for
        # checking purposes)
        for i in xrange(3*table._v_maxTuples):
            row['var1'] = '%04d' % (self.appendrows - i)
            row['var7'] = row['var1'][-1]
        ...
        assert len(result) == 20+3*table._v_maxTuples
...
class DefaultValues(unittest.TestCase):
    ...
    def test00(self):
        ...
        table._v_maxTuples=46   # minimum amount that reproduces a problem
...
class WhereAppendTestCase(common.TempFileMixin, common.PyTablesTestCase):
    ...
    def test01_compatible(self):
        ...
        class DstTblDesc(IsDescription):
            ...
            v1 = FloatCol()
            v2 = StringCol(length=16)  # a longer column
    ...
    def test03_incompatible(self):
        ...
        class DstTblDesc(IsDescription):
            id = StringCol(length=4)  # string, not int
            v1 = FloatCol()
            v2 = StringCol(length=8)
        ...
        self.assertRaises(TypeError, tbl1.whereAppend, tbl2, tbl1.cols.id > 1)
