...
class BroadcastTestCase(common.TempFileMixin, common.PyTablesTestCase):
    ...
    def test00_simple(self):
        ...
        if a.shape[0] > 0:
            ...
            a1 = self.h5file.create_earray(root, 'a1', atom=tb.Int32Col(), shape=a.shape)
...
class MaindimTestCase(common.TempFileMixin, common.PyTablesTestCase):
    ...
    def test00_simple(self):
        ...
        a1 = self.h5file.create_earray(root, 'a1', atom=tb.Int32Col(), shape=shape)
        b1 = self.h5file.create_earray(root, 'b1', atom=tb.Int32Col(), shape=shape)
        c1 = self.h5file.create_earray(root, 'c1', atom=tb.Int32Col(), shape=shape)
        a1.append(a)
        b1.append(b)
        c1.append(c)
        # The expression
    ...
    def test01_out(self):
        ...
        b1 = self.h5file.create_earray(root, 'b1', atom=tb.Int32Col(), shape=shape)
        c1 = self.h5file.create_earray(root, 'c1', atom=tb.Int32Col(), shape=shape)
        r1 = self.h5file.create_earray(root, 'r1', atom=tb.Int32Col(), shape=shape)
        a1.append(a)
        b1.append(b)
        c1.append(c)
        r1.append(c)
    ...
    def test02_diff_in_maindims(self):
        ...
        b1 = self.h5file.create_earray(root, 'b1', atom=tb.Int32Col(), shape=shape2)
    ...
    def test03_diff_in_out_maindims(self):
        ...
        b1 = self.h5file.create_earray(root, 'b1', atom=tb.Int32Col(), shape=shape)
        c1 = self.h5file.create_earray(root, 'c1', atom=tb.Int32Col(), shape=shape)
        r1 = self.h5file.create_earray(root, 'r1', atom=tb.Int32Col(), shape=shape2)
