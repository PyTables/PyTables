...
class Atom(metaclass=MetaAtom):
    ...
    *base element* (also known as *atom*) of CArray, EArray and
    ...
    def _get_init_args(self):
        ...
        args = [
            arg for arg, p in parameters.items()
...
class _BufferedAtom(PseudoAtom):
    ...
    def toarray(self, object_):
        ...
        array = np.ndarray(buffer=buffer_,
...
class VLStringAtom(_BufferedAtom):
    ...
    def _tobuffer(self, object_):
        if isinstance(object_, str):
            warnings.warn(
                "Storing non bytestrings in VLStringAtom is "
...
class VLUnicodeAtom(_BufferedAtom):
    ...
    def toarray(self, object_):
        if isinstance(object_, bytes):
            warnings.warn(
                "Storing bytestrings in VLUnicodeAtom is "
                "deprecated.", DeprecationWarning)
